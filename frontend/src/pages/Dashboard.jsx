...
function SkeletonCards() {
  return (
    <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:'20px', marginBottom:'40px' }}>
      {[1,2,3,4,5].map(i => (
        <div key={i} style={{ height:'140px', borderRadius:'20px', border:'1px solid rgba(255,255,255,0.02)',
...
function SkeletonCharts() {
  return (
    <div style={{ display:'grid', gridTemplateColumns:'1fr', gap:'24px', marginBottom:'24px' }}>
      <div style={{ height:'350px', borderRadius:'24px',
  ...
  return (
    <div className="mx-auto w-full max-w-[1200px] px-4 sm:px-6 lg:px-8 py-8"
      ...
      {loading ? (
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))', gap:'20px', marginBottom:'40px' }}>
          {STATS.map(s => (
            <div key={s.label} style={{ borderRadius:'20px', border:'1px solid rgba(255,255,255,0.06)',
